...
public final class App {
    public static void main(String[] args) throws Exception {
        ...
        JarFileData _data = BytecodeManipulation.ParseJarFile(input);

        Map<String, byte[]> classesData = _data.classesData;
        Map<String, byte[]> resources = _data.resources;

        Map<String, ClassNode> classNodes = _data.classNodes;
        ...
        Map<String, ClassNode> modifedClasses = BytecodeManipulation.RenameClass(renameArguments);
