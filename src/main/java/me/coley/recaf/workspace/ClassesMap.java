...
/**
 * Map for the classes. Values in this map are "cached" representations of what
 * is stored in the raw backing map.
 *
 * @author Matt
 */
public class ClassesMap extends HashMap<String, ClassNode> {
	...
	/**
	 * @param content Map of class names to their raw bytecode.
	 */
	 ...
	 * @param classFile Raw class bytecode.
	 */
	...
	/**
	 * When a new class instance is put into the map, the raw backing map should be
	 * updated too.
	 *
	 * @param key   Class name.
	...
	// NOTE: It seems like entrySet doesn't need to be overriden if keySet/values
	// are.
}
