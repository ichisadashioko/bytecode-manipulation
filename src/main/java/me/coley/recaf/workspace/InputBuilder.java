...
public class InputBuilder {
     ...
     *
     * @throws IOException Thrown if the archive could not be read, or an internal
     ...
     */
    private Map<String, byte[]> readInstrumentation(Instrumentation instrumentation) throws IOException {
     ...
     *
     * @throws IOException Thrown if stream could not be read or if ClassNode could
     *                     not be derived from the streamed content.
     */
    private void addClass(Map<String, byte[]> contents, String name, InputStream is) throws IOException {
        ...
        try {
            ...
            Logging.warn(String.format("Could not read archive entry: '%s' as a class. Added as " + "resource instead.",
                    name));
