...
public class ClassUtil {
	 ...
	 * 
	 * @param bs Array of class bytecode.
	 ...
	 * @throws IOException If an exception occurs while loading the class.
	 */
	 ...
	 * 
	 * @param cr Reader to parse class with.
	 ...
	 *
	 * @param cn The target ClassNode.
	 * @return ByteArray representation of cn.
	 * @throws Exception Thrown when the node could not be regenerated. There are a
